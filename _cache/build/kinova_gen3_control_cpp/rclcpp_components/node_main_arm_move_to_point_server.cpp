...
#define NODE_MAIN_LOGGER_NAME "arm_move_to_point_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<kinova_gen3_control_cpp::ArmMoveToPointServer>";
